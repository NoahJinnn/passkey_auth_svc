...
func (aq *AssetQuery) QueryInstitution() *InstitutionQuery {
...
func (aq *AssetQuery) WithInstitution(opts ...func(*InstitutionQuery)) *AssetQuery {
	query := (&InstitutionClient{config: aq.config}).Query()
...
//
//	client.Asset.Query().
//		GroupBy(asset.FieldInstitutionID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Asset.Query().
//		Select(asset.FieldInstitutionID).
//		Scan(ctx, &v)
...
func (aq *AssetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Asset, error) {
	...
	if query := aq.withInstitution; query != nil {
		if err := aq.loadInstitution(ctx, query, nodes, nil,
			func(n *Asset, e *Institution) { n.Edges.Institution = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *AssetQuery) loadInstitution(ctx context.Context, query *InstitutionQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Institution)) error {
...
func (aq *AssetQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := aq.ctx.Fields; len(fields) > 0 {
		...
		if aq.withInstitution != nil {
			_spec.Node.AddColumnOnce(asset.FieldInstitutionID)
		}
	}
