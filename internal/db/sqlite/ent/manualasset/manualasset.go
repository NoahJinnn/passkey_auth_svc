...
const (
	// Label holds the string label denoting the manualasset type in the database.
	Label = "manual_asset"
	...
	// FieldAssetTableID holds the string denoting the asset_table_id field in the database.
	...
	// Table holds the table name of the manualasset in the database.
	Table = "manual_assets"
)

// Columns holds all SQL columns for manualasset fields.
var Columns = []string{
	FieldID,
	FieldProviderName,
	FieldAssetTableID,
...
// OrderOption defines the ordering options for the ManualAsset queries.
...
// ByAssetTableID orders the results by the asset_table_id field.
func ByAssetTableID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAssetTableID, opts...).ToFunc()
}
