...
func (tu *TodoUpdate) SetListId(i int) *TodoUpdate {
	tu.mutation.ResetListId()
	tu.mutation.SetListId(i)
	return tu
}

// SetNillableListId sets the "listId" field if the given value is not nil.
func (tu *TodoUpdate) SetNillableListId(i *int) *TodoUpdate {
	if i != nil {
		tu.SetListId(*i)
	}
	return tu
...
func (tu *TodoUpdate) AddListId(i int) *TodoUpdate {
	tu.mutation.AddListId(i)
	return tu
}
...
func (tu *TodoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.ListId(); ok {
		_spec.SetField(todo.FieldListId, field.TypeInt, value)
	}
	if value, ok := tu.mutation.AddedListId(); ok {
		_spec.AddField(todo.FieldListId, field.TypeInt, value)
	}
...
// SetListId sets the "listId" field.
func (tuo *TodoUpdateOne) SetListId(i int) *TodoUpdateOne {
	tuo.mutation.ResetListId()
	tuo.mutation.SetListId(i)
	return tuo
}

// SetNillableListId sets the "listId" field if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableListId(i *int) *TodoUpdateOne {
	if i != nil {
		tuo.SetListId(*i)
	}
	return tuo
...
// AddListId adds i to the "listId" field.
func (tuo *TodoUpdateOne) AddListId(i int) *TodoUpdateOne {
	tuo.mutation.AddListId(i)
	return tuo
}
...
func (tuo *TodoUpdateOne) sqlSave(ctx context.Context) (_node *Todo, err error) {
	...
	if value, ok := tuo.mutation.ListId(); ok {
		_spec.SetField(todo.FieldListId, field.TypeInt, value)
	}
	if value, ok := tuo.mutation.AddedListId(); ok {
		_spec.AddField(todo.FieldListId, field.TypeInt, value)
	}
