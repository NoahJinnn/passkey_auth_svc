...
func (cq *ConnectionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (cq *ConnectionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (cq *ConnectionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (cq *ConnectionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (cq *ConnectionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (cq *ConnectionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
