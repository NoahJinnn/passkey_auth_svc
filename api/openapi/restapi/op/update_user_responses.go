...
/*
UpdateUserOK Create a user successfully.
...
func (o *UpdateUserOK) WithPayload(payload *model.LinkTokenCreateResp) *UpdateUserOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update user o k response
func (o *UpdateUserOK) SetPayload(payload *model.LinkTokenCreateResp) {
	o.Payload = payload
}
...
/*
UpdateUserDefault General errors using same model as used by go-swagger for validation errors.
...
func (o *UpdateUserDefault) WithPayload(payload *model.Error) *UpdateUserDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update user default response
func (o *UpdateUserDefault) SetPayload(payload *model.Error) {
	o.Payload = payload
}
