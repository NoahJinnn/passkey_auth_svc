...
func (o *UpdateUserOK) Error() string {
	return fmt.Sprintf("[PATCH /user][%d] updateUserOK  %+v", 200, o.Payload)
}
...
func (o *UpdateUserOK) GetPayload() *model.LinkTokenCreateResp {
	return o.Payload
}
...
func (o *UpdateUserDefault) Error() string {
	return fmt.Sprintf("[PATCH /user][%d] UpdateUser default  %+v", o._statusCode, o.Payload)
}
...
func (o *UpdateUserDefault) GetPayload() *model.Error {
	return o.Payload
}
