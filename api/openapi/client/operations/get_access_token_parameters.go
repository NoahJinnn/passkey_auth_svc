...
// WithPublicToken adds the publicToken to the get access token params
func (o *GetAccessTokenParams) WithPublicToken(publicToken string) *GetAccessTokenParams {
	o.SetPublicToken(publicToken)
	return o
}

// SetPublicToken adds the publicToken to the get access token params
func (o *GetAccessTokenParams) SetPublicToken(publicToken string) {
...
func (o *GetAccessTokenParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// form param public_token
	frPublicToken := o.PublicToken
	fPublicToken := frPublicToken
	if fPublicToken != "" {
		if err := r.SetFormParam("public_token", fPublicToken); err != nil {
			return err
		}
	}
