...
func (m *Email) validateData(formats strfmt.Registry) error {
...
func (m *Email) validatePrimary(formats strfmt.Registry) error {
...
func (m *Email) contextValidateEmpty(ctx context.Context, formats strfmt.Registry) error {
