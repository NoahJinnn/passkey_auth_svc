...
type IPasscodeSvc interface {
	InitPasscode(ctx Ctx, userId uuid.UUID, emailId uuid.UUID) (string, *ent.Passcode, error)
}
...
func (svc *passcodeSvc) InitPasscode(ctx Ctx, userId uuid.UUID, emailId uuid.UUID) (string, *ent.Passcode, error) {
	...
	return passcode, passcodeModel, nil
}
