...
CREATE TABLE `new_providers` (`id` uuid NOT NULL, `user_id` uuid NULL, `verified` bool NOT NULL DEFAULT false, `created_at` datetime NOT NULL, `updated_at` datetime NOT NULL, PRIMARY KEY (`id`));
