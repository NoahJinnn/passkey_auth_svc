...
func (ld *LoanDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, LoanMutation](ctx, ld.sqlExec, ld.mutation, ld.hooks)
}
...
func (ld *LoanDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(loan.Table, sqlgraph.NewFieldSpec(loan.FieldID, field.TypeUint))
