...
const (
	// Label holds the string label denoting the assettable type in the database.
	Label = "asset_table"
	...
	EdgeUser = "user"
	// Table holds the table name of the assettable in the database.
	Table = "asset_tables"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "asset_tables"
...
// Columns holds all SQL columns for assettable fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldSheet,
...
// OrderOption defines the ordering options for the AssetTable queries.
