...
const (
	// Label holds the string label denoting the webauthnsessiondatum type in the database.
	Label = "webauthn_session_datum"
	...
	// Table holds the table name of the webauthnsessiondatum in the database.
...
// Columns holds all SQL columns for webauthnsessiondatum fields.
var Columns = []string{
	FieldID,
	FieldChallenge,
	FieldUserID,
