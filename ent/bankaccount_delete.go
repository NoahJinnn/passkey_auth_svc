...
func (bad *BankAccountDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, BankAccountMutation](ctx, bad.sqlExec, bad.mutation, bad.hooks)
}
...
func (bad *BankAccountDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(bankaccount.Table, sqlgraph.NewFieldSpec(bankaccount.FieldID, field.TypeUint))
