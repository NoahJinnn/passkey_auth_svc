...
const (
	// Label holds the string label denoting the finitemtable type in the database.
	Label = "fin_item_table"
	...
	EdgeUser = "user"
	// Table holds the table name of the finitemtable in the database.
	Table = "fin_item_tables"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "fin_item_tables"
...
// Columns holds all SQL columns for finitemtable fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldSheet,
...
// OrderOption defines the ordering options for the FinItemTable queries.
