...
func (baq *BankAccountQuery) QueryUser() *UserQuery {
...
func (baq *BankAccountQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (baq *BankAccountQuery) FirstIDX(ctx context.Context) uint {
...
func (baq *BankAccountQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (baq *BankAccountQuery) OnlyIDX(ctx context.Context) uint {
...
func (baq *BankAccountQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (baq *BankAccountQuery) IDsX(ctx context.Context) []uint {
	ids, err := baq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (baq *BankAccountQuery) WithUser(opts ...func(*UserQuery)) *BankAccountQuery {
	query := (&UserClient{config: baq.config}).Query()
...
func (baq *BankAccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*BankAccount, error) {
	...
	if query := baq.withUser; query != nil {
		if err := baq.loadUser(ctx, query, nodes, nil,
			func(n *BankAccount, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (baq *BankAccountQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*BankAccount, init func(*BankAccount), assign func(*BankAccount, *User)) error {
	ids := make([]uint, 0, len(nodes))
	nodeids := make(map[uint][]*BankAccount)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (baq *BankAccountQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(bankaccount.Table, bankaccount.Columns, sqlgraph.NewFieldSpec(bankaccount.FieldID, field.TypeUint))
	_spec.From = baq.sql
