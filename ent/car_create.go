...
func (cc *CarCreate) SetUserID(u uint) *CarCreate {
	cc.mutation.SetUserID(u)
	return cc
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (cc *CarCreate) SetNillableUserID(u *uint) *CarCreate {
	if u != nil {
		cc.SetUserID(*u)
	}
	return cc
...
func (cc *CarCreate) SetID(u uint) *CarCreate {
	cc.mutation.SetID(u)
	return cc
}
...
func (cc *CarCreate) createSpec() (*Car, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(car.Table, sqlgraph.NewFieldSpec(car.FieldID, field.TypeUint))
	)
