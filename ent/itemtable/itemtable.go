...
const (
	// Label holds the string label denoting the itemtable type in the database.
	Label = "item_table"
	...
	EdgeUser = "user"
	// Table holds the table name of the itemtable in the database.
	Table = "item_tables"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "item_tables"
...
// Columns holds all SQL columns for itemtable fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldSheet,
...
// OrderOption defines the ordering options for the ItemTable queries.
